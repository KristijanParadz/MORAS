...
Proof.
revert y. simpl. induction x.
-reflexivity.
-destruct y.
--reflexivity.
-- simpl. intros. f_equal.  destruct a,b;reflexivity.
...
Proof.
Compute AddLr (repeat I 5) (repeat I 5) O.
...
assert (L : AddLr (repeat I n) (repeat I n) I= (repeat I n)).
{ induction n. - reflexivity. - simpl. rewrite IHn. reflexivity. }

intros. simpl. destruct H. destruct H0.  rewrite H. rewrite H0. unfold AddL. 
rewrite help. rewrite P_rev_2. induction n.
-contradiction. 
- simpl. rewrite help2. rewrite P_rev_2. rewrite help3. reflexivity.
Qed.
